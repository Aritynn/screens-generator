...
DEL %screensDirectory%*.png >NUL 2>&1
 ...
 -i "%inputFilePath%"^
 -loglevel error^
 -vf [in]drawtext="fontfile=C\\:/Windows/Fonts/arial.ttf:fontcolor=white:fontsize=18:text='Frame Number\: %%{frame_num}':start_number=0:x=2:y=2:borderw=2:bordercolor=#202020",drawtext="fontfile=C\\:/Windows/Fonts/arial.ttf:fontcolor=white:fontsize=18:text='Picture Type\: %%{pict_type}':start_number=0:x=2:y=22:borderw=2:bordercolor=#202020",drawtext="fontfile=C\\:/Windows/Fonts/arial.ttf:fontcolor=white:fontsize=18:text='%%{pts\:hms}':start_number=0:x=0:y=42:borderw=2:bordercolor=#202020",drawtext="fontfile=C\\:/Windows/Fonts/arial.ttf:fontcolor=white:fontsize=18:text='Encode':start_number=0:x=2:y=62:borderw=2:bordercolor=#202020",setpts=PTS,select="not(mod(n\,%interval%))*eq(pict_type\,B)"[out]^
 -vsync 0^
 -stats^
 -f image2^
 -start_number 0^
...
pause
 ...
 ffmpeg -analyzeduration 2147483647 -probesize 2147483647 -i "C:\inputFilePath.mkv" -loglevel error -vf [in]drawtext="fontfile=C\\:/Windows/Fonts/arial.ttf:fontcolor=white:fontsize=18:text='Frame Number\: %%{frame_num}':start_number=0:x=2:y=2:borderw=2:bordercolor=#202020",drawtext="fontfile=C\\:/Windows/Fonts/arial.ttf:fontcolor=white:fontsize=18:text='Picture Type\: %%{pict_type}':start_number=0:x=2:y=22:borderw=2:bordercolor=#202020",drawtext="fontfile=C\\:/Windows/Fonts/arial.ttf:fontcolor=white:fontsize=18:text='%%{pts\:hms}':start_number=0:x=0:y=42:borderw=2:bordercolor=#202020",drawtext="fontfile=C\\:/Windows/Fonts/arial.ttf:fontcolor=white:fontsize=18:text='Encode':start_number=0:x=2:y=62:borderw=2:bordercolor=#202020",setpts=PTS,select="not(mod(n\,%interval%))*eq(pict_type\,B)"[out] -vsync 0 -stats -f image2 -start_number 0 -frame_pts 1 "C:\outputname%%d.png"